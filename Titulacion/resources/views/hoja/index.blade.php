                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('hojas.destroy',$hoja->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('hojas.show',$hoja->id) }}"><i class="fa fa-fw fa-eye"></i> Ver</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('hojas.edit',$hoja->id) }}"><i class="fa fa-fw fa-edit"></i> Editar</a>
                                                    @csrf
                                                    @method('DELETE')
